...
(deftheme molokai-gruber-darker
  "molokai-gruber-darker theme")
...
(custom-theme-set-faces
 ...
 ;; from gruber-darker-theme
 '(helm-source-header ((t (:foreground "#ffdd33" :background "#181818"))))
 '(helm-candidate-number ((t (:background "#181818" :foreground "#ffdd33" :bold t))))
 '(helm-ff-directory ((t (:foreground "#96a6c8" :background "#181818" :bold t))))
 '(helm-ff-executable ((t (:foreground "#73c936"))))
 '(helm-ff-file ((t (:foreground "#e4e4ef" :inherit nil))))
 ...
 ;; self
 '(helm-match ((t (:background "#282828"))))
...
(provide-theme 'molokai-gruber-darker)
